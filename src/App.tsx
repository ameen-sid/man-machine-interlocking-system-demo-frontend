        ...
        <BrowserRouter>
          <Routes>
            ...
            <Route path="/" element={
              ...
              <Route path="monitor" element={<FactoryMonitor />} />
              ...
              <Route path="attendance" element={<OperatorAttendance />} />
              <Route path="prod-plan" element={<ProductionPlan />} />
              <Route path="prod-plan/:id" element={<OrderDetails />} />
              <Route path="prod-plan/pipeline" element={<ProductionPipeline />} />
