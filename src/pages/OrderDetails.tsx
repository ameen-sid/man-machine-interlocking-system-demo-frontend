...
import { ArrowLeft, TrendingUp, Clock, Box } from "lucide-react";
import {
	XAxis,
	YAxis,
	CartesianGrid,
			...
			<div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6">
				<div>
					<div className="flex items-center gap-3 mb-2">
						<span className="px-3 py-1 bg-industrial-accent text-black text-[10px] font-black uppercase rounded">
							ACTIVE BATCH
						</span>
				...
				<div className="flex gap-4">
					<div className="text-right">
						...
						<p className="text-2xl font-mono font-bold text-industrial-accent">
							{order.target} Units
						</p>
					</div>
				</div>
			...
			<div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
				...
				<div className="space-y-6">
					<div className="glass-card p-8 rounded-3xl border border-white/5 text-center space-y-6">
						<p className="text-[10px] font-black uppercase text-gray-500 tracking-widest text-left">
							Total Progress
						</p>
						...
						<div className="space-y-2">
							<p className="text-xs font-bold">
								{order.current} of {order.target} Units
							</p>
						...
						<div className="space-y-3">
							{[
								...
								<div
									...
									<span
										className={`font-mono text-xs ${m.status === "optimal" ? "text-green-500" : "text-industrial-accent"}`}>
										{m.val}
									</span>
								</div>
							))}
