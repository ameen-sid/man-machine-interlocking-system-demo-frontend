		...
		<div className="space-y-8 p-4">
			...
			<div className="glass-card rounded-2xl border border-white/5 overflow-hidden">
				<table className="w-full text-left text-xs">
					<thead className="bg-white/5">
						<tr>
							<th className="p-4 font-black uppercase text-gray-400 tracking-widest">
								Date
							</th>
							<th className="p-4 font-black uppercase text-gray-400 tracking-widest">
								Station
							...
							<th className="p-4 font-black uppercase text-gray-400 tracking-widest text-right">
								Status
							</th>
						</tr>
					</thead>
			...
			<div className="flex items-center gap-3 p-4 bg-blue-500/5 rounded-xl border border-blue-500/10">
				...
				<p className="text-[10px] text-blue-400 font-medium">
					This log displays data for the current month (April 2026).
					All records are cryptographically signed by the MMI Security
					Module.
				</p>
			</div>
		</div>
