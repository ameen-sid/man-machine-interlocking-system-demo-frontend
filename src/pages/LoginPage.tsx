      ...
      >
        <div className="text-center mb-12 space-y-3">
          ...
          <h1 className="text-3xl font-black tracking-tighter uppercase">
            MMI <span className="text-industrial-accent">Secure Portal</span>
          </h1>
          <p className="text-gray-500 font-mono text-xs uppercase tracking-widest leading-loose">
            UNAUTHORIZED ACCESS IS STRICTLY MONITORED<br/>SYSTEM NODE: SECURE-GATEWAY-01
          </p>
        </div>
        ...
        <div className="glass-card p-10 rounded-3xl border border-white/5 relative overflow-hidden shadow-3xl">
          ...
          <div className="mt-8 text-center">
             <a href="#" className="text-[10px] font-bold text-gray-600 uppercase hover:text-industrial-accent transition-colors tracking-widest underline decoration-white/10 underline-offset-4">
