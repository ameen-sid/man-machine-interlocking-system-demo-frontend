  ...
  return (
    <div className="space-y-8">
      ...
      <div className="flex justify-between items-end">
        <div>
          <h2 className="text-3xl font-black uppercase tracking-tight text-gray-400">Production <span className="text-white">Vault</span></h2>
          <p className="text-gray-600 text-sm font-mono uppercase">Historical Imprints & Audited Execution Logs</p>
        </div>
        <div className="relative hidden md:block">
           <Search className="absolute left-3 top-2.5 w-4 h-4 text-gray-600" />
           <input type="text" placeholder="Lookup Transaction Hash..." className="bg-white/5 border border-white/10 rounded-lg pl-10 pr-4 py-2 text-[10px] w-64 focus:outline-none focus:border-white/20" />
        </div>
      </div>
           ...
           >
              <div className="flex justify-between items-start">
                 <div className="flex items-center gap-3">
                    ...
                    <div>
                       <h3 className="font-bold text-lg">{arc.month}</h3>
                       <p className="text-[10px] font-mono text-gray-600 uppercase">Archive ID: SR-{200 + i}</p>
                    </div>
                 </div>
                 <div className="flex items-center gap-2 px-3 py-1 bg-white/5 rounded-full border border-white/10">
                    <Lock className="w-3 h-3 text-gray-700" />
                    <span className="text-[9px] font-black uppercase text-gray-600">{arc.status}</span>
                 </div>
              </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                 <div className="p-4 bg-white/5 rounded-2xl border border-white/5">
                    ...
                    <p className="font-mono text-xl font-bold">{arc.orders}</p>
                 </div>
                 <div className="p-4 bg-white/5 rounded-2xl border border-white/5">
                    <p className="text-[10px] font-bold text-gray-500 uppercase">Avg Yield</p>
                    <p className="font-mono text-xl font-bold text-green-500">{arc.yield}</p>
                 </div>
              </div>
