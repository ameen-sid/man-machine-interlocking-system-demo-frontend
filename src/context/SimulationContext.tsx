...
const INITIAL_OPERATORS: Operator[] = [
	{
		...
		name: "Mohit",
		level: 3,
		certifications: ["CNC-Expert", "Safety-L3"],
	},
	{ id: "op-02", name: "Rahul", level: 1, certifications: ["Basic-Lathe"] },
	{
		...
		name: "Sneha",
		level: 2,
		certifications: ["Assembly-Advanced"],
	},
	{
		id: "op-04",
		name: "Anita",
		level: 2,
		certifications: ["Robotics-Basic"],
	},
];
